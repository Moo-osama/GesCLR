...
class DecompressPose:
    ...
    def __init__(self, squeeze=True, max_person=10, isTest=False):
    ...
    def __call__(self, results):
        ...
        if self.isTest:
            with open("/home/osabdelfattah/MotionBert_k400/num_person_MB.txt", "a") as file:
                file.write(str(num_person) + ",")
